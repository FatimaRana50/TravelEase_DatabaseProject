...
namespace DB_module2 {
    ...
    public partial class formsDataSet : global::System.Data.DataSet {
        ...
        public partial class registrationDataTable : global::System.Data.TypedTableBase<registrationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public registrationRow AddregistrationRow(string username, string password, string name, string email, string city, System.DateTime dob, string phone, string gender) {
...
namespace DB_module2.formsDataSetTableAdapters {
    ...
    public partial class loginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DB_module2.Properties.Settings.Default.formsConnectionString;
        }
        ...
        public virtual int Fill(formsDataSet.loginDataTable dataTable) {
        ...
        public virtual formsDataSet.loginDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            formsDataSet.loginDataTable dataTable = new formsDataSet.loginDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(formsDataSet.loginDataTable dataTable) {
    ...
    public partial class registrationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[registration] ([username], [password], [name], [email], [city], [dob], [phone], [gender]) VALUES (@username, @password, @name, @email, @city, @dob, @phone, @gender);
SELECT username, password, name, email, city, dob, phone, gender FROM registration WHERE (username = @username)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@username", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "username", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@password", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "password", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[registration] SET [username] = @username, [password] = @password, [name] = @name, [email] = @email, [city] = @city, [dob] = @dob, [phone] = @phone, [gender] = @gender WHERE (([username] = @Original_username) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_city = 1 AND [city] IS NULL) OR ([city] = @Original_city)) AND ((@IsNull_dob = 1 AND [dob] IS NULL) OR ([dob] = @Original_dob)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)));
SELECT username, password, name, email, city, dob, phone, gender FROM registration WHERE (username = @username)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT username, password, name, email, city, dob, phone, gender FROM dbo.registr" +
                "ation";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        public virtual int Delete(string Original_username, string Original_password, string Original_name, string Original_email, string Original_city, global::System.Nullable<global::System.DateTime> Original_dob, string Original_phone, string Original_gender) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string username, string password, string name, string email, string city, global::System.Nullable<global::System.DateTime> dob, string phone, string gender) {
            if ((username == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string password, string name, string email, string city, global::System.Nullable<global::System.DateTime> dob, string phone, string gender, string Original_username, string Original_password, string Original_name, string Original_email, string Original_city, global::System.Nullable<global::System.DateTime> Original_dob, string Original_phone, string Original_gender) {
            return this.Update(Original_username, password, name, email, city, dob, phone, gender, Original_username, Original_password, Original_name, Original_email, Original_city, Original_dob, Original_phone, Original_gender);
        }
    }
